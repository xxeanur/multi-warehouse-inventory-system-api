...
namespace MultiWarehouse.Entity.Entities
{
    ...
    {
        public string Sku { get; set; } = string.Empty; // Stok Tutma Birimi (Barkod veya ürüne özel benzersiz kod)
        ...
        // Fiziksel Özellikler (Rafa sığıp sığmayacağını hesaplamak için hayati önem taşır)
